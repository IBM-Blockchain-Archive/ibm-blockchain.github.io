...
if [ "$(kubectl get svc | grep composer-playground | wc -l | grep -o -E '[0-9]+')" == "0" ]; then
...
NUMPENDING=$(kubectl get deployments | grep composer-playground | awk '{print $5}' | grep 0 | wc -l | grep -o -E '[0-9]+')
