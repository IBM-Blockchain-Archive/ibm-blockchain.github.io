...
if [ "$(kubectl get pods -a | grep chaincodeinstall | wc -l | awk '{print $1}' | grep -o -E '[0-9]+')" != "0" ]; then
    ...
    while [ "$(kubectl get pods -a | grep chaincodeinstall | wc -l | awk '{print $1}' | grep -o -E '[0-9]+')" != "0" ]; do
